...
<html>
<head>
	<title> Basic HTML and CSS Question </title>
...
<body>
			...
			<form class="UserDetails" name = "register" action="user_data.php" method="POST">
				<p style="text-align: center;color:ivory; font-size:large;"> REGISTER HERE </p>
				      <input type="text" placeholder="Name"  name="Name">
	  				  <input type="text" placeholder="Email" name="Mail" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" required="">
	...
	<div class="quiz_box">
		...
		<footer>
			<div class="total_que">
				<!--<span><p>2</p><p>of</p><p>10</p><p>Questions</p></span>-->	
			</div>
